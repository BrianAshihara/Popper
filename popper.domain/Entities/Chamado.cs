...
namespace popper.domain.Entities
{
    public class Chamado : BaseEntity<int>
    {
        ...
        public Chamado(int id, string? desc, string? status, DateTime? hora, Usuario? usuario_idusuario, Tecnico? tecnico_idtecnico, TipoChamado? tipochamado_idtipochamado, Local? local_idlocal ):base(id)
        {
            Desc = desc;
            Status = status;
            Hora = hora;
